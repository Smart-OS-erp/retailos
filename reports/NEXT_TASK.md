...
- Review and merge the Integration Hub UI/data-source setup flow.
- Design the RetailOS Import API authentication/idempotency boundary before implementation.
- Build RetailOS Import API only after API authentication, tenant scoping, replay handling, and idempotency details are reviewed.
...
- Integration Hub UI/data-source setup flow is implemented locally on branch `phase-0-5-integration-hub-ui` and pending review.
